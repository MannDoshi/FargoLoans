...
public class EmployeeController {
	...
	public ResponseEntity<?> registerEmployee(@Validated @RequestBody Employee e) throws ResourceNotFoundException {
		Employee e1 = eservice.getEmployee(e.getEmpId())
	...
	@PutMapping("/{id}")
	public ResponseEntity<Employee> updateProduct(@PathVariable(value = "id") Long pId,
			@Validated @RequestBody Employee e) throws ResourceNotFoundException {
		Employee employee = eservice.getSingleProduct(pId)
	...
	public Map<String, Boolean> deleteProduct(@PathVariable(value = "id") Long pId) throws ResourceNotFoundException {
		Employee e = eservice.getSingleProduct(pId)
				.orElseThrow(() -> new ResourceNotFoundException("Employee not found for this Id :" + pId));
